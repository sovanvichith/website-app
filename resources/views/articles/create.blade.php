                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title mb-0">Create New Article</h4>
                            </div>
                            <div class="col-auto">
                        ...
                        <form method="POST" action="{{ route('articles.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Enter article description (max 200 characters)" required>{{ old('description') }}</textarea>
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="las la-save me-1"></i> Save Article
                                </button>
